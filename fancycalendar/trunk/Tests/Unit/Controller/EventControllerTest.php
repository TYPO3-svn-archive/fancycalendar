...
/**
 * Test case for class Tx_Fancycalendar_Controller_EventController.
 *
 * @version $Id$
 ...
 */
class Tx_Fancycalendar_Controller_EventControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
